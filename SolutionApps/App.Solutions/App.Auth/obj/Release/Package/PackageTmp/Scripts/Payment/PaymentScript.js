    ...
    try {
        if (ResultData.Message == "Success" && ResultData.Status == true) {
            ...
            $.each(Result_Data.flights_details, function (FD_Key, FD_Value) {
                ...
                Confirmation_FlightDetails += "<tr><td rowspan='2'><p>" + (FD_Value.AirlineName == null ? Airline_Name(FD_Value.MarketingAirline) : Airline_Name(FD_Value.AirlineName)) + "</p> <p class='fl_heading'><strong> Flight # " + (FD_Value.AirlineName == null ? FD_Value.MarketingAirline : FD_Value.AirlineName) + "  " + FD_Value.FlightNumber.replace(/^0+/, '') + "</strong></p></td>";
            ...
            Confirmation_PaymentDetail += "<div class='col-md-6 no-padding'> " + sessionStorage.getItem('CurrencyCode') + Result_Data.currCode_details.PaymentAmount + "</div>";
            //  Confirmation_PaymentDetail += "</div>";
            Confirmation_PaymentDetail += "</div>";
            // Confirmation_PaymentDetail += "<div class='row'>";
            Confirmation_PaymentDetail += "<div class='col-md-12'>";
            ...
            //Confirmation_PaymentDetail += "<div class='col-md-6'>" +  Result_Data.passengers_details[0].passengername + "<br>" + Result_Data.passengers_details[0].passengerAddress + "</div>";
            // Confirmation_PaymentDetail += "</div>";
            ...
            error_title_title += "<div class='col-md-6'><a href='http://bookings.flypapa.com/' class='btn btn-primary'>Select Another Fare</a></div>";
    ...
    try {
        ...
        if (FilterAllFlightSegmentArray != 'undefined' && FilterAllFlightSegmentArray != null) {
            ...
            var SaveRecords = {
                ...
                DefaultCompanyId: sessionStorage.getItem("CompanyTypeId"),
                BillingEmail: $('#txtBCIEmail').val(),
                BillingPhone: $('#txtBCIEmail').val(),
                BillingName: $('#txtFirstNameAdults0').val(),
    ...
    try {
        ...
        $.each(myPassengerDetailsListArray, function (dt_key, dt_value) {
            ...
            for (var i = 0; i < parseInt(dt_value.Adults) ; i++) {
                ...
                AppPassengerDetailsData += "<div class='form-group col-md-1'><select class='form-control' id='SelTDTitleAdults" + i + "' style='width:100%; height: 27px; margin-top: 0px;'><option>Mr.</option><option>Ms.</option><option>Miss.</option><option>Mstr.</option></select></div>";
            ...
            for (var i = 0; i < parseInt(dt_value.Childrens) ; i++) {
                ...
                AppPassengerDetailsData += "<div class='form-group col-md-1'><select class='form-control' id='SelTDTitleChildrens" + i + "' style='width:100%; height:27px; margin-top: 0px; '><option>Mr.</option><option>Ms.</option><option>Miss.</option><option>Mstr.</option></select></div>";
                ...
                AppPassengerDetailsData += "<div class='form-group col-md-2'><div class='input-group col-xs-11 col-sm-11' style='float:left;'><input class='form-control  date-picker  Restrictinput ' id='txtDOBDateChildrens" + i + "' type='text'  placeholder='Date of Birth'  name='date-range-picker' data-date-format='yyyy-mm-dd' style='width:96%; height:27px; margin-top: 0px; '  /><span class='input-group-addon' id='col_txtDOBDateChildrens" + i + "'><i class='fa fa-calendar bigger-80'></i></span></div><span style='float:left;' class='stat_col'>*</span></div>";
            ...
            for (var i = 0; i < parseInt(dt_value.Infants) ; i++) {
                ...
                AppPassengerDetailsData += "<div class='form-group col-md-1'><select class='form-control' id='SelTDTitleInfants" + i + "' style='width:100%; height:27px; margin-top: 0px; ; '><option>Inf.</option><option>Mr.</option><option>Ms.</option><option>Miss.</option><option>Mstr.</option></select></div>";
                ...
                AppPassengerDetailsData += "<div class='form-group col-md-2'><div class='input-group col-xs-11 col-sm-11' style='float:left;'><input class='form-control  date-picker  Restrictinput ' id='txtDOBDateInfants" + i + "' type='text'  placeholder='Date of Birth'  name='date-range-picker' data-date-format='yyyy-mm-dd' style='width:100%; height:27px; margin-top: 0px; '  /><span class='input-group-addon' id='col_txtDOBDateInfants" + i + "'><i class='fa fa-calendar bigger-80'></i></span></div><span style='float:left;' class='stat_col'>*</span></div>";
                AppPassengerDetailsData += "<div class='form-group col-md-1'><select class='form-control' id='selTDGenderInfants" + i + "' style='width:100%; height:27px'><option value='MI'>Male</option><option  value='FI'>Female</option></select></div>";
                AppPassengerDetailsData += "<div class='space-8'></div></div>";
            }
            if (parseInt(dt_value.OnSeat) > 0) {
            ...
            for (var i = 0; i < parseInt(dt_value.OnSeat) ; i++) {
                AppPassengerDetailsData += "<div class='col-md-12 table-responsive'>";
                AppPassengerDetailsData += "<div class='form-group col-md-1'><label class='form-control' style='width:100%; height:27px; margin-top: 0px; margin-left: 10px;'>" + (i + 1) + ":</label></div>";
                AppPassengerDetailsData += "<div class='form-group col-md-1'><select class='form-control' id='SelTDTitleOnSeat" + i + "' style='width:100%; height:27px; margin-top: 0px;  '><option>Mr.</option><option>Ms.</option><option>Miss.</option><option>Mstr.</option><option>Dr.</option></select></div>";
                ...
                AppPassengerDetailsData += "<div class='form-group col-md-2'><div class='input-group col-xs-12 col-sm-12'><input class='form-control  date-picker  Restrictinput ' id='txtDOBDateOnSeat" + i + "' type='text'  placeholder='Date of Birth'  name='date-range-picker' data-date-format='yyyy-mm-dd' style='width:100%; height:27px; margin-top: 0px; '  /><span class='input-group-addon' id='col_txtDOBDateOnSeat" + i + "'><i class='fa fa-calendar bigger-80'></i></span></div></div>";
            ...
            for (var i = 0; i < parseInt(dt_value.Seniors) ; i++) {
                AppPassengerDetailsData += "<div class='col-md-12 table-responsive'>";
                AppPassengerDetailsData += "<div class='form-group col-md-1'><label class='form-control' style='width:100%; height:27px; margin-top: 0px; margin-left: 10px;'>" + (i + 1) + ":</label></div>";
                AppPassengerDetailsData += "<div class='form-group col-md-1'><select class='form-control' id='SelTDTitleSeniors" + i + "' style='width:100%; height:27px; margin-top: 0px;  '><option>Mr.</option><option>Ms.</option><option>Miss.</option><option>Mstr.</option><option>Dr.</option></select></div>";
                ...
                AppPassengerDetailsData += "<div class='form-group col-md-2'><div class='input-group col-xs-12 col-sm-12'><input class='form-control  date-picker  Restrictinput ' id='txtDOBDateSeniors" + i + "' type='text'  placeholder='Date of Birth'  name='date-range-picker' data-date-format='yyyy-mm-dd' style='width:100%; height:27px; margin-top: 0px; '  /><span class='input-group-addon' id='col_txtDOBDateSeniors" + i + "'><i class='fa fa-calendar bigger-80'></i></span></div></div>";
        ...
        if (SelectedAirLineAllFlightSegment_Data != 'undefined' && SelectedAirLineAllFlightSegment_Data != null) {
            ...
            if (SelectedAirLineAllFlightSegment_Data.length > 0) {
                ...
                $.each(FightsArray, function (All_key, All_value) {
                    var FlightSegments = All_value.OriginDestinationFlight[0].FlightSegments.length;
                    debugger;

                    LastDepDate = All_value.OriginDestinationFlight[FlightSegments - 1].FlightSegments[0].DepartureDateTime;
                    ...
                    $.each(All_value.FlightSegments, function (Segment_key, Segment_value) {
                        if (AirItinerary == 0) {
                            ...
                            for (var i = 0; i < AirItineraryPricingInformation.PTC_FareBreakdowns.PTC_FareBreakdown.length; i++) {
                                ...
                                dynamicDetails += "<td class='text-right'>" + parseFloat(AirItineraryPricingInformation.PTC_FareBreakdowns.PTC_FareBreakdown[i].PassengerTypeQuantity.Quantity * AirItineraryPricingInformation.PTC_FareBreakdowns.PTC_FareBreakdown[i].PassengerFare.EquivFare.Amount).toFixed(2) + "</td>";
                                dynamicDetails += "<td class='text-right'>" + parseFloat(AirItineraryPricingInformation.PTC_FareBreakdowns.PTC_FareBreakdown[i].PassengerTypeQuantity.Quantity * AirItineraryPricingInformation.PTC_FareBreakdowns.PTC_FareBreakdown[i].PassengerFare.Taxes.TotalTax.Amount).toFixed(2) + "</td>";
                                dynamicDetails += "<td class='text-right'>" + parseFloat(AirItineraryPricingInformation.PTC_FareBreakdowns.PTC_FareBreakdown[i].PassengerTypeQuantity.Quantity * AirItineraryPricingInformation.PTC_FareBreakdowns.PTC_FareBreakdown[i].PassengerFare.TotalFare.Amount).toFixed(2) + "</td></tr>";

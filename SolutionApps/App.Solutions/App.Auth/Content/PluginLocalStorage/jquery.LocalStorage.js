 ...
 * SessionStorage
 *
 * Copyright (c) 19/11/2015 Rakesh Pal & Team (rmsi.com)
...
;(function($, undefined){
	/* Variables I'll need throghout */
    var supported, ls, mod = 'testlocalStorage';
	if ('localStorage' in window){
		try {
			ls = (typeof window.localStorage === 'undefined') ? undefined : window.localStorage;
			if (typeof ls == 'undefined' || typeof window.JSON == 'undefined'){
	...
	$.localStorage = function(key, value, options){
	    return $.localStorage.impl.init(key, value);
	};
	$.localStorage.setItem = function (key, value) {
	    return $.localStorage.impl.setItem(key, value);
	};
	$.localStorage.getItem = function (key) {
	    return $.localStorage.impl.getItem(key);
	};
	$.localStorage.getAll = function () {
	    return $.localStorage.impl.getAll();
	};
	$.localStorage.deleteItem = function (key) {
	    return $.localStorage.impl.deleteItem(key);
	};
	/* Object to hold all methods: public and private */
	$.localStorage.impl = {
		init: function(key, value){
...
;(function($, undefined){
	/* Variables I'll need throghout */
    var supported, ls, mod = 'testsessionStorage';
	if ('sessionStorage' in window) {
		try {
			...
			window.sessionStorage.setItem(mod, '1');
	...
	/* Make the methods public */
	$.sessionStorage = function(key, value, options){
	    return $.sessionStorage.impl.init(key, value);
	};
	$.sessionStorage.setItem = function (key, value) {
	    return $.sessionStorage.impl.setItem(key, value);
	};
	$.sessionStorage.getItem = function (key) {
	    return $.sessionStorage.impl.getItem(key);
	};
	$.sessionStorage.getAll = function () {
	    return $.sessionStorage.impl.getAll();
	};
	$.sessionStorage.deleteItem = function (key) {
	    return $.sessionStorage.impl.deleteItem(key);
	};
	/* Object to hold all methods: public and private */
	$.sessionStorage.impl = {
		init: function(key, value){

...
using App.Services.Auth.Models;
using App.Services.Auth.Providers;
using App.Services.Auth.Results;
...
namespace App.Services.Auth.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // GET api/Account/CheckUserLogin
        
        [AllowAnonymous]
        [Route("CheckUserLogin")]
        [System.Web.Http.HttpGet]
        [System.Web.Http.AcceptVerbs("GET", "POST")]
        public CheckUserLogin CheckUserLogin()
        {

...
function OnLoadGetDataList() {
    try {
        ...
        var ReqURL = "";
        var DHCData = { ReqestURL: ReqURL, USERID: 543211 };
        MasterAppConfigurationsServices("POST", CommonConfiguration.WebAPIServicesURL + "API/AirBooking", JSON.stringify(DHCData), ResultCallBackSuccess, ResultCallBackError);
    } catch (e) {
        var error = e;
        error = error;
    }

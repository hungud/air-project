  $( function() {
    var availableTags = ['Aalborg, Denmark (AAL)', 
'Aalesund, Norway (AES)', 
...
'Abidjan, Cote d&lsquo;Ivoire (ABJ)', 
...
'Arthur&lsquo;s Town, Bahamas (ATC)', 
'Arua, Uganda (RUA)', 
'Aruba, Aruba (AUA)', 
'Arusha, Tanzania (ARK)', 
...
'Cabo San Lucas, &lsquo;Los Cabos&lsquo;, Mexico (SJD)', 
'Caen, France (CFR)', 
...
'Cotarou, Benin (COC)', 
'Cox&lsquo;s Bazar, Bangladesh (CXB)', 
'Cozumel, Mexico (CZM)', 
...
'Gafsa, Tunisia (GAF)', 
'Gagnoa, Cote D&lsquo;Ivoire (GGN)', 
...
'San Jose, Costa Rica - Tobias Bolanos Int&lsquo;l (SYQ)', 
...
'Zurich, Switzerland (ZRH)'];
    $( "#OBdep1, #OBarr1, #OBdep2, #OBarr2, #OBdep3, #OBarr3, #OBdep4, #OBarr4, #OBdep5, #OBarr5, #hotelDestination, #pickUp, #dropOff" ).autocomplete({

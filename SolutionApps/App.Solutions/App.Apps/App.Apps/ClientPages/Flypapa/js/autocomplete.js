...
$(function () {
    ...
    $('#OBdep1,#RBdep1,#RBarr1,#MBdep2,#MBarr2,#MBdep5,#MBarr5,#MBdep4,#MBarr4,#MBdep3,#MBarr3, #OBarr1, #OBdep2, #OBarr2, #OBdep3, #OBarr3, #OBdep4, #OBarr4, #hotelDestination, #pickUp, #dropOff').autocomplete({

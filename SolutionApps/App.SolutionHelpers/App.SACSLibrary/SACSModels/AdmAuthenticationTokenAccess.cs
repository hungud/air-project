...
namespace SACS.Models
{
    ...
    /// </summary>
    public class AdmAuthenticationTokenAccess
    {
        public class AppConfigProgram
        {
            public void GetGenDataMain()
            {
                AdmAccessToken admToken;
                string headerValue;
                //Get Client Id and Client Secret from https://datamarket.azure.com/developer/applications/
                //Refer obtaining AccessToken (http://msdn.microsoft.com/en-us/library/hh454950.aspx) 
                AdmAuthentication admAuth = new AdmAuthentication("V1:ho11ip93d7oi1y7b:DEVCENTER:EXT", "WkS7r7pN");
                try
                {

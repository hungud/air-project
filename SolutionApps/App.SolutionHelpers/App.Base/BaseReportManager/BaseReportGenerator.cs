...
namespace App.Base.BaseReportManager
{
	public class BaseReportGenerator
	{
        ...
        public BaseReportGenerator(DataTable dt, string dsName)
		{
			this.dt = dt;
			this.dsName = dsName;
		}
        ...
        public Stream GeneraReport()
		{
			...
			writer.WriteStartDocument();
			{
				...
				writer.WriteAttributeString("xmlns", "rd", "", nsRd);
				{
                    ...
                    RectangleF dimensioni = new RectangleF(0.07301F, 0.08783F, 13.25397F, 2.98941F);
				...
				case SezioneTabella.Header:
					{
						nomeSezione = "Header";
						templateValore = "{0}";
                        colors = new CellColors(Color.Gray, Color.White);
						break;
					}

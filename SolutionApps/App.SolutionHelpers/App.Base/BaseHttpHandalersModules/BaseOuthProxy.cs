namespace App.Base
{
    namespace BaseOuthProxy
    {
        ...
        /// Summary     :   BaseOuthProxy for ArcGIS Server Security Services. 
        /// OAuth 2.0
        /// Token-based
        /// HTTP/Windows
        /// CORS
        ...
        /// </summary>
        public class BaseOuthProxy : IHttpHandler, IDisposable
        {
            /// <summary>
            /// 
            /// </summary>
            ...
            */
            ...
            /// <param name="ignoreAuthenticationErrors"></param>
            /// <returns></returns>
            ...
            /// <param name="tokenParamName"></param>
            /// <returns></returns>
        ...
        public class ProxyConfig
        {
            ...
            public static ProxyConfig GetCurrentConfig()
            {
                ...
                if (config == null)
                {
                    ...
                    string fileName = HttpContext.Current.Server.MapPath("~/App_Data/Web.Configuration/Proxy.config");

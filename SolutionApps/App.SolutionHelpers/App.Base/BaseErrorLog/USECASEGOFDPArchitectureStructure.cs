namespace App.Base
{
    namespace USECASEGOFDPArchitectureStructure
    {
        using System;
        using System.Web;
        using System.IO;
        ...
        namespace GOFDPArchitectureStructure
        {
            ...
            /// 
            /// </summary>
            public class USECASEGOFDPArchitectureStructureSample
            {
                public USECASEGOFDPArchitectureStructureSample()
                {
                    ...
                    new BehavioralDesign.ObserverDesignPattern.ObserverDesignPattern().GetObserverDesignPattern();
            ...
            namespace BehavioralDesign
            {
                ...
                namespace ObserverDesignPattern
                {
                    ...
                    public class ObserverDesignPattern
                    {
                        ...
                        public void GetObserverDesignPattern()
                        {
